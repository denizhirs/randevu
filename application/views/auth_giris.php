...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        input[type="email"], input[type="password"] { width: 100%; padding: 12px; border: 2px solid #e9ecef; border-radius: 6px; font-size: 14px; transition: border-color 0.3s; }
        ...
        .success { background: #d4edda; color: #155724; padding: 12px; border-radius: 6px; margin-bottom: 20px; border-left: 4px solid #28a745; }
...
<body>
    <div class="container">
        ...
        <form method="post" action="<?php echo base_url('auth/giris'); ?>">
        ...
        <div class="link">
            <a href="<?php echo base_url('auth/kayit'); ?>">Hesabınız yok mu? Kayıt olun</a>
        </div>
    </div>
</body>
</html>
